...
<form name="form1" id="form1" method="post" action="?" enctype="multipart/form-data">
	...
	<div id="products" class="contents-main">
	    ...
	    <table class="table">
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <input type="text" name="name" value="<!--{$arrForm.name|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.name != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" class="span5" />
	                ...
	                <table class="table-no-borders">
	                    <tr>
	                        ...
	                        <td style="padding: 15px;">
	                            <a class="btn" href="javascript:;" name="on_select" onclick="fnMoveSelect('category_id_unselect','category_id'); return false;"><i class="icon-chevron-sign-left"></i>&nbsp;登録&nbsp;&nbsp;</a><br /><br />
	                            <a class="btn" href="javascript:;" name="un_select" onclick="fnMoveSelect('category_id','category_id_unselect'); return false;">&nbsp;&nbsp;削除&nbsp;<i class="icon-chevron-sign-right"></i></a>
	                        </td>
	                        <td>
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <input type="text" name="down_filename" value="<!--{$arrForm.down_filename|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.down_filename != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->" class="span5" />
	                <span class="warning"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span>
	            </td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <input type="text" name="product_code" value="<!--{$arrForm.product_code|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.product_code != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" class="span5" />
	                <span class="warning"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span>
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                ...
	                <input type="text" name="price01" value="<!--{$arrForm.price01|h}-->" class="input-mini" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.price01 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/><span class="add-on">円</span>
	                </div>
	                <span class="warning"> (半角数字で入力)</span>
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                ...
	                <div class="input-append">
	                <input type="text" name="price02" value="<!--{$arrForm.price02|h}-->" class="input-mini" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.price02 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/><span class="add-on">円</span>
	                </div>
	                <span class="warning"> (半角数字で入力)</span>
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                ...
	                <input type="text" name="stock" value="<!--{$arrForm.stock|h}-->" class="input-mini" maxlength="<!--{$smarty.const.AMOUNT_LEN}-->" style="<!--{if $arrErr.stock != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/>
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <div class="input-append">
	                <input type="text" name="deliv_fee" value="<!--{$arrForm.deliv_fee|h}-->" class="input-mini" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.deliv_fee != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/><span class="add-on">円</span>
	                </div>
	                <span class="warning"> (半角数字で入力)</span>
	                <!--{if $smarty.const.OPTION_PRODUCT_DELIV_FEE != 1}--><br /><span class="warning">※現在無効です</span> (パラメーター OPTION_PRODUCT_DELIV_FEE)<!--{/if}-->
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                ...
	                <div class="input-append">
	                <input type="text" name="point_rate" value="<!--{$arrForm.point_rate|default:$arrForm.arrInfo.point_rate|h}-->" class="input-mini" maxlength="<!--{$smarty.const.PERCENTAGE_LEN}-->" style="<!--{if $arrErr.point_rate != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/><span class="add-on">％</span>
	                </div>
	                <span class="warning"> (半角数字で入力)</span>
	            </td>
	        </tr>
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <input type="text" name="sale_limit" value="<!--{$arrForm.sale_limit|h}-->" class="input-mini" maxlength="<!--{$smarty.const.AMOUNT_LEN}-->" style="<!--{if $arrErr.sale_limit != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/>
	                <span class="warning"> (半角数字で入力)</span>
	            </td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <input type="text" name="comment1" value="<!--{$arrForm.comment1|h}-->" maxlength="<!--{$smarty.const.URL_LEN}-->" class="span5" style="<!--{$arrErr.comment1|sfGetErrorColor}-->" />
	                <span class="warning"> (上限<!--{$smarty.const.URL_LEN}-->文字)</span>
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                ...
	                <textarea name="comment3" rows="8" class="span6" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{$arrErr.comment3|sfGetErrorColor}-->"><!--{"\n"}--><!--{$arrForm.comment3|h}--></textarea><br />
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <textarea name="note" rows="8" class="span6" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{$arrErr.note|sfGetErrorColor}-->"><!--{"\n"}--><!--{$arrForm.note|h}--></textarea><br />
	                <span class="warning"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)</span>
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                ...
	                <textarea name="main_list_comment" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" style="<!--{if $arrErr.main_list_comment != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" rows="8" class="span6"><!--{"\n"}--><!--{$arrForm.main_list_comment|h}--></textarea><br />
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <textarea name="main_comment" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{if $arrErr.main_comment != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" rows="8" class="span6"><!--{"\n"}--><!--{$arrForm.main_comment|h}--></textarea><br />
	                <span class="warning"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)</span>
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                ...
	                <a class="btn" href="javascript:;" name="btn" onclick="selectAll('category_id'); fnModeSubmit('upload_image', 'image_key', '<!--{$key}-->'); return false;"><i class="icon-upload"></i> アップロード</a>
	            </td>
	        </tr>
	        <tr>
	    ...
	    <a class="btn" href="javascript:;" onclick="selectAll('category_id'); lfDispSwitch('sub_detail'); return false;"><span>サブ情報表示/非表示</span></a>
	    ...
	    <table class="table">
	        ...
	        <tr>
	            ...
	            <td>
	                <span class="attention"><!--{$arrErr[$key]}--></span>
	                <input type="text" name="sub_title<!--{$smarty.section.cnt.iteration}-->" value="<!--{$arrForm[$key]|h}-->" class="span5" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->"/>
	                <span class="warning"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span>
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
	                <span class="attention"><!--{$arrErr[$key]}--></span>
	                <textarea name="sub_comment<!--{$smarty.section.cnt.iteration}-->" rows="8" class="span6" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->"><!--{"\n"}--><!--{$arrForm[$key]|h}--></textarea><br />
	                <span class="warning"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)</span>
	            </td>
	        </tr>
	        <tr>
	        ...
	        <a class="btn" href="javascript:;" onclick="selectAll('category_id'); lfDispSwitch('recommend_select'); return false;"><span>関連商品表示/非表示</span></a>
	    ...
	    <table class="table">
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <a class="btn" href="javascript:;" name="change" onclick="selectAll('category_id'); win03('./product_select.php?no=<!--{$smarty.section.cnt.iteration}-->', 'search', '615', '500'); return false;">変更</a>
	                ...
	                <textarea name="<!--{$key}-->" rows="8" class="span6" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" ><!--{"\n"}--><!--{$arrRecommend[$recommend_no].comment|h}--></textarea><br />
	                <span class="warning"> (上限<!--{$smarty.const.LTEXT_LEN}-->文字)</span>
	            </td>
	        </tr>
	        <!--{/section}-->
	...
	<br /><br />
	    <div class="btn-area">
	        ...
	        <a class="btn " href="javascript:;" onclick="fnChangeAction('<!--{$smarty.const.ADMIN_PRODUCTS_URLPATH}-->'); fnModeSubmit('search','',''); return false;"><span class="btn-prev">検索画面に戻る</span></a>
	        <!--{/if}-->
	        <a class="btn btn-primary" href="javascript:;" onclick="selectAll('category_id'); document.form1.submit(); return false;"><span class="btn-next">確認ページへ</span></a>
	    </div>
	</div>
</form>