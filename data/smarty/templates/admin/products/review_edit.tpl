    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" class="span5" name="reviewer_name" value="<!--{$arrForm.reviewer_name|h}-->" style="<!--{$arrErr.reviewer_name|sfGetErrorColor}-->" >
            </td>
        </tr>
        <tr>
            <th>投稿者URL</th>
            <td>
                ...
                <input type="text" class="span5" name="reviewer_url" maxlength="<!--{$smarty.const.URL_LEN}-->" value="<!--{$arrForm.reviewer_url|h}-->" style="<!--{$arrErr.reviewer_url|sfGetErrorColor}-->" >
            </td>
        </tr>
        <tr>
            <th>性別</th>
            <td><div class="inline"><!--{html_radios_ex name="sex" options=$arrSex selected=$arrForm.sex}--></div></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" class="span5" name="title" value="<!--{$arrForm.title|h}-->" style="<!--{$arrErr.title|sfGetErrorColor}-->" size=30><span class="attention">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <textarea name="comment" rows="10" class="span6" wrap="soft" style="<!--{$arrErr.comment|sfGetErrorColor}-->" ><!--{"\n"}--><!--{$arrForm.comment|h}--></textarea>
            </td>
        </tr>
    </table>

    <div class="btn-area">
        <a class="btn" href="javascript:;" onclick="document.form1.action='./review.php'; fnModeSubmit('search','',''); return false;" ><span class="btn-prev">検索画面に戻る</span></a>
        <a class="btn btn-primary" href="javascript:;" onclick="fnModeSubmit('complete','',''); return false;"><span class="btn-next">この内容で登録する</span></a>
    </div>
</div>
</form>
