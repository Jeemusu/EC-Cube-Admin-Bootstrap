...
<tr>
    ...
    <input type="text" name="<!--{$key}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key].value|h}-->" class="span3" <!--{if $arrErr[$key]}--><!--{sfSetErrorStyle}--><!--{/if}--> /></td>
    <th>都道府県</th>
    <td>
        <!--{assign var=key value="search_pref"}-->
        <!--{if $arrErr[$key]}--><span class="attention"><!--{$arrErr[$key]}--></span><br /><!--{/if}-->
        <select class="input-medium" name="<!--{$key}-->" >
...
<tr>
    ...
    <td>
            ...
            <!--{if $arrErr[$key]}--><span class="attention"><!--{$arrErr[$key]}--></span><br /><!--{/if}-->
            <input type="text" name="<!--{$key}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key].value|h}-->" class="span3" <!--{if $arrErr[$key]}--><!--{sfSetErrorStyle}--><!--{/if}--> />
    </td>
    <th>お名前(フリガナ)</th>
    <td>
...
<tr>
    ...
    <!--{assign var=errkey2 value="search_b_end_year"}-->
        ...
        <select class="input-small" name="<!--{$key}-->" <!--{if $arrErr[$errkey1] || $arrErr[$errkey2]}--><!--{sfSetErrorStyle}--><!--{/if}-->>
            <option value="" selected="selected">----</option>
            <!--{html_options options=$arrBirthYear selected=$arrForm[$key].value}-->
        </select> 年
        <!--{assign var=key value="search_b_start_month"}-->
        <select class="input-mini" name="<!--{$key}-->" <!--{if $arrErr[$errkey1] || $arrErr[$errkey2]}--><!--{sfSetErrorStyle}--><!--{/if}-->>
            <option value="" selected="selected">--</option>
            <!--{html_options options=$arrMonth selected=$arrForm[$key].value}-->
        </select> 月
...
<tr>
    ...
    <input type="text" name="<!--{$key}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key].value|h}-->" class="span5" <!--{if $arrErr[$key]}--><!--{sfSetErrorStyle}--><!--{/if}-->/>
    </td>
</tr>
<tr>
    <th>携帯メールアドレス</th>
    <td colspan="3">
        ...
        <!--{if $arrErr[$key]}--><span class="attention"><!--{$arrErr[$key]}--></span><!--{/if}-->
        <input type="text" name="<!--{$key}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key].value|h}-->" class="span5" <!--{if $arrErr[$key]}--><!--{sfSetErrorStyle}--><!--{/if}-->/></td>
</tr>
<tr>
    <th>電話番号</th>
    <td colspan="3">
        ...
        <!--{if $arrErr[$key]}--><span class="attention"><!--{$arrErr[$key]}--></span><br /><!--{/if}-->
        <input type="text" name="<!--{$key}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key].value|h}-->" class="span5" /></td>
</tr>
<tr>
    <th>職業</th>
    <td colspan="3">
...
<tr>
    ...
    <td>
        ...
        <input type="text" name="<!--{$key1}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key1].value|h}-->" class="span1" <!--{if $arrErr[$key1] || $arrErr[$key2]}--><!--{sfSetErrorStyle}--><!--{/if}--> /><span class="add-on">円</span>
        </div> ～ 
        <div class="input-append">
        <input type="text" name="<!--{$key2}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key2].value|h}-->" class="span1" <!--{if $arrErr[$key1] || $arrErr[$key2]}--><!--{sfSetErrorStyle}--><!--{/if}--> /><span class="add-on">円</span></div>
    </td>
    <th>購入回数</th>
    <td>
    ...
    <!--{/if}-->
    <div class="input-append">
    <input type="text" name="<!--{$key1}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key1].value|h}-->" class="span1" <!--{if $arrErr[$key1] || $arrErr[$key2]}--><!--{sfSetErrorStyle}--><!--{/if}--> /><span class="add-on">回</span></div> ～
    <div class="input-append">
    <input type="text" name="<!--{$key2}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key2].value|h}-->" class="span1" <!--{if $arrErr[$key1] || $arrErr[$key2]}--><!--{sfSetErrorStyle}--><!--{/if}--> /><span class="add-on">回</span></div></td>
</tr>
<tr>
    <th>登録・更新日</th>
    <td colspan="3">
...
<tr>
    ...
    <td>
        ...
        <input type="text" name="<!--{$key}-->" maxlength="<!--{$arrForm[$key].length}-->" value="<!--{$arrForm[$key].value|h}-->" class="span3" style="<!--{$arrErr[$key]|sfGetErrorColor}-->"/>
        </span>
    </td>
    <th>購入商品コード</th>
    <td>
        ...
        <!--{if $arrErr[$key]}--><span class="attention"><!--{$arrErr[$key]}--></span><!--{/if}-->
        <input type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|h}-->" maxlength="<!--{$arrForm[$key].length}-->" class="span3" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" >
    </td>
</tr>
<tr>
    <th>カテゴリ</th>
