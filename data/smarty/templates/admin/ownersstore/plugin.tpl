...
<div id="system" class="contents-main">
    ...
    <table class="table">
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-primary" href="javascript:;" onclick="install(); return false;"><span class="btn-next">インストール</span></a>
            </td>
        </tr>
    </table>
    ...
    <!--{if count($plugins) > 0}-->
        ...
        <table class="table" width="900">
            ...
            <tr <!--{if $plugin.enable == $smarty.const.PLUGIN_ENABLE_FALSE}--> style="background:#ccc;" <!--{/if}-->>
                <!--ロゴ-->
                        ...
                        <div>
                            ...
                            <!-- 設定 -->
                                <!--{if $plugin.config_flg == true && $plugin.status != $smarty.const.PLUGIN_STATUS_UPLOADED}-->
                                    <a class="btn" href="?" onclick="win02('../load_plugin_config.php?plugin_id=<!--{$plugin.plugin_id}-->', 'load', 615, 400);return false;">プラグイン設定</a>&nbsp;|&nbsp;
                                <!--{else}-->
                                    <span>プラグイン設定&nbsp;|&nbsp;</span>
                                <!--{/if}-->
                            <!-- アップデート -->
                                <a class="update_link btn" href="javascript:;" name="<!--{$plugin.plugin_id}-->">アップデート</a>
                            <!-- 削除 -->
                                <a class="btn btn-danger" href="javascript:;" name="uninstall" onclick="uninstall(<!--{$plugin.plugin_id}-->, '<!--{$plugin.plugin_code}-->'); return false;">削除</a>
                            <!-- 有効/無効 -->
                ...
                <td class="center">
                    ...
                    <input type="text" class="input-mini" name="priority_<!--{$plugin.plugin_code}-->" value="<!--{$plugin.priority|h}-->" size="1" class="priority" />
                    
                   
                    <a class="btn" href="javascript:;" onclick="update_priority(<!--{$plugin.plugin_id}-->, '<!--{$plugin.plugin_code}-->'); return false;">変更</a>
