...
<div id="system" class="contents-main">
    ...
    <h2>管理機能設定</h2>
    <table class="table" id="basis-index-admin">
        <tr>
            <th>ディレクトリ名</th>
            <td>
                <!--{assign var=key value="admin_dir"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <div class="input-prepend input-append"><span class="add-on"><!--{$smarty.const.ROOT_URLPATH}--></span><input type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key]|h}-->" maxlength="<!--{$smarty.const.ID_MAX_LEN}-->" class="span4" style="<!--{if $arrErr[$key] != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"/><span class="add-on">/</span>
            </td>
        </tr>
        <tr>
            <th>SSL制限</th>
        ...
        <tr>
            ...
            <td>
                ...
                <span class="warning"> (上限<!--{$smarty.const.LTEXT_LEN}-->文字)</span><br />
    ...
    <div class="btn-area">
        <a class="btn btn-primary" href="#"><span class="btn-next">この内容で登録する</span></a>
    </div>
</div>
