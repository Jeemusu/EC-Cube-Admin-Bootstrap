...
<form style="margin:0;padding:0 20px;" name="form1" id="form1" method="post" action="?">
...
<div class="btn-area">
    <a class="btn btn-primary" href="javascript:;" onclick="fnFormModeSubmit('form1', 'search', '', ''); return false;" name="subm"><span class="btn-next">検索を開始</span></a>
</div>
...
<!--{if $smarty.post.mode == 'search'}-->
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td class="center"><a class="btn" href="" onClick="return func_submit(<!--{$arrCustomer[cnt].customer_id|h}-->)">決定</a></td>
        </tr>
        <!--▲会員<!--{$smarty.section.cnt.iteration}-->-->
        <!--{sectionelse}-->
        <tr>
