...
<input type="hidden" name="mode" value="search" />
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td colspan="3">
            <div class="inline">
            <!--{html_checkboxes name="search_status" options=$arrStatus separator="&nbsp;" selected=$arrForm.search_status.value}--></td>
            </div>
        </tr>
    </table>
    <div>
        <p class="page_rows">検索結果表示件数
        <select class="input-mini" name="search_page_max">
...
<!--{/foreach}-->
    ...
    <div class="btn-area-top">
        ...
        <a class="btn" href="javascript:;" onclick="location.href='../contents/csv.php?tpl_subno_csv=customer'"><i class="icon-cog"></i> CSV 出力項目設定</a>
    </div>
    <!--{if count($arrData) > 0}-->
    ...
    <!--検索結果表示テーブル-->
    <table class="table" id="customer-search-result">
        <col width="8%" />
        <col width="10%" />
        <col width="30%" />
        <col width="8%" />
        ...
        <tr>
            ...
            <th class="center" rowspan="2">性別</th>
            <th>TEL</th>
            <th class="center" rowspan="2">編集</th>
            <th class="center" rowspan="2">削除</th>
        </tr>
        <tr>
            <th>都道府県</th>
            <th>メールアドレス</th>
        ...
        <!--{foreach from=$arrData item=row}-->
            <tr>
                ...
                <td class="center" rowspan="2"><span class="icon_edit"><a class="btn" href="#" onclick="return fnEdit('<!--{$row.customer_id|h}-->');">編集</a></span></td>
                <td class="center" rowspan="2"><span class="icon_delete"><a class="btn btn-danger" href="#" onclick="return fnDelete('<!--{$row.customer_id|h}-->');">削除</a></span></td>
            </tr>
            <tr>
