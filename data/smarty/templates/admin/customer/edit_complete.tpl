...
<form name="form1" id="form1" method="post" action="?">
    ...
    <!--{/foreach}-->
        ...
        <div class="btn-area">
                ...
                <!--{if $arrSearchData}-->
                 <a class="btn" href="javascript:;" onclick="return fnReturn();"><span class="btn-prev">検索結果へ戻る</span></a>
                <!--{/if}-->
                <a class="btn btn-primary" href="javascript:;" onclick="fnFormModeSubmit('form1', 'complete_return', '', ''); return false;"><span class="btn-next">続けて登録を行う</span></a>
