...
<table class="table">
    ...
    <tr>
        <th>商品名</th>
        <td><input type="text" name="search_name" value="<!--{$arrForm.search_name|h}-->" class="span5" /></td>
    </tr>
    <tr>
        <th>商品コード</th>
        <td><input type="text" name="search_product_code" value="<!--{$arrForm.search_product_code|h}-->" class="span5" /></td>
    </tr>
</table>
<div class="btn-area">
                ...
                <tr style="background:<!--{$arrPRODUCTSTATUS_COLOR[$status]}-->;">
                    ...
                    <td>
                        ...
                        <dl>
                            ...
                            <dd>
                                <select class="input-medium" name="classcategory_id1" id="<!--{$class1}-->" style="<!--{$arrErr[$class1]|sfGetErrorColor}-->"    onchange="fnSetClassCategories(this.form);">
                        ...
                        <dl>
                            ...
                            <dd>
                                <select class="input-medium" name="classcategory_id2" id="<!--{$class2}-->" style="<!--{$arrErr[$class2]|sfGetErrorColor}-->" onchange="fnCheckStock(this.form);"></select>
                                <!--{if $arrErr[$class2] != ""}-->
                    ...
                    <td class="center"><a class="btn" href="javascript:;" onclick="return func_submit('<!--{$arrProducts[cnt].product_id}-->', '<!--{$tpl_class_name1[$id]}-->', '<!--{$tpl_class_name2[$id]}-->'); return false;">決定</a></td>
                </tr>
                <!--▲商品<!--{$smarty.section.cnt.iteration}-->-->
            </form>
        <!--{sectionelse}-->
