...
<div id="mail" class="contents-main">
    ...
    <div class="btn-area">
        <a class="btn" href="javascript:;" name="subm02" onclick="return fnInsertValAndSubmit( document.form1, 'mode', 'regist_back', '' ); return false;"><span class="btn-prev">テンプレート設定画面へ戻る</span></a>
           <a class="btn-primary btn" href="javascript:;" name="subm03" onClick="return fnInsertValAndSubmit( document.form1, 'mode', 'regist_complete', '' ); return false;"><span class="btn-next">配信する</span></a>
    </div>
</div>
</form>
