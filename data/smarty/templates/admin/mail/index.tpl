...
<!--{/foreach}-->
    ...
    <div class="btn-area-top">
        ...
        <!--{/if}-->
        <!--{if $tpl_linemax > 0}-->
            <a class="btn" href="javascript:;" onclick="document.form1['mode'].value='input'; document.form1.submit(); return false;"><span><i class="icon-cog"></i> 配信内容を設定する</span></a>
        <!--{/if}-->
    </div>
