...
<!--{if $tpl_mode|strlen == 0 || $arrErr|@count >= 1}-->
    ...
    <form name="form1" id="form1" method="get" action="?" onsubmit="return false;">
        ...
        <div class="basis-zip-item">
            ...
            <p><a class="btn btn-primary" href="javascript:;" onclick="fnModeSubmit('auto', '', ''); return false;"><span class="btn-next">自動登録</span></a></p>
        </div>
        ...
        <div class="basis-zip-item">
            ...
            <!--{else}-->
                ...
                <p><a class="btn btn-primary" href="javascript:;" onclick="fnModeSubmit('update_csv', '', ''); return false;"><span class="btn-next">更新</span></a><span class="attention"><!--{$arrErr.startRowNum}--></span></p>
            <!--{/if}-->
        </div>
        ...
        <div class="basis-zip-item end">
            ...
            <p><a class="btn btn-danger" href="javascript:;" onclick="fnModeSubmit('delete', '', ''); return false;"><span class="btn-next">削除</span></a></p>
        </div>
    </form>
<!--{else}-->
