    ...
    <div id="home-main">
       ...
       <h2>システム情報</h2>
        <table class="table">
            ...
            <tr>
                <th>詳細</th>
                <td><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->system/system.php">システム情報</a></td>
            </tr>
        </table>
        ...
        <table class="table">
            ...
            <tr>
                <td class="center"><!--{$arrNewOrder[i].create_date}--></td>
                <td class="center"><!--{$arrNewOrder[i].name01|h}--> <!--{$arrNewOrder[i].name02|h}--></td>
                <td class="center"><!--{$arrNewOrder[i].product_name|h}--></td>
                <td class="center"><!--{$arrNewOrder[i].payment_method|h}--></td>
                <td class="center"><!--{$arrNewOrder[i].total|number_format}-->円</td>
            </tr>
            <!--{/section}-->
        </table>
